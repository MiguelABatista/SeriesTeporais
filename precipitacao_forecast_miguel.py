...
df = pd.read_csv('meteorologia/diarios_rio/A601.csv', index_col = 'Data')
...
df1['Week'] = df1.index.strftime('%U') #aquele comando nao rodava na minha versao do pandas
...
hw = ExponentialSmoothing(imputed_train['Precipitacao_hw'], initialization_method = 'legacy-heuristic',
